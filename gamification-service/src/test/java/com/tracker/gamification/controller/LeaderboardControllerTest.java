...
public class LeaderboardControllerTest {
    ...
    void testGetLeaderboard() throws Exception {
        var entry1 = new LeaderboardEntryDto(1, 1L, 500.0);
        var entry2 = new LeaderboardEntryDto(2, 2L, 300.0);
    ...
    void testGetActivityLeaderboard() throws Exception {
        var entry = new LeaderboardEntryDto(1, 5L, 200.0);
    ...
    void testGetMyRank_readsUserIdHeader() throws Exception {
        when(leaderboardService.getMyRank(7L)).thenReturn(3);
